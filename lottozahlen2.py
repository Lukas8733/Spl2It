...
import random
random.seed()
tipp = input("Bitte Zahlen eingeben")
tipps = tipp.split(",")
...
while tipps != lottogezogen:
	...
	if(lottogezogen != tipps):
		counter = counter + 1
	if(lottogezogen == tipps):
		print("Es hat",counter,"durchläufe gedauerz")
		break

	
print("Die Zahlen lauten",lottogezogen,"und wurden nach",counter,"ziehungen gezogen")